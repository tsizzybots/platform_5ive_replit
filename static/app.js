...
async function sendTestMessage() {
    ...
    try {
        ...
        typingIndicator.innerHTML = `<div style="font-weight: bold; color: white; margin-bottom: 6px;">IzzyBots AI Agent</div><div style="color: white;"><i class="fas fa-spinner fa-spin"></i> Typing...</div>`;
        ...
        aiMessageDiv.innerHTML = `<div style="font-weight: bold; color: white; margin-bottom: 6px;">IzzyBots AI Agent</div><div style="color: white;">${aiMessage}</div>`;
                            ...
                            <div class="session-message mb-3 ${msg.userAi === 'ai' ? 'ai-message' : 'user-message'}">
                                ...
                                ">
                                    <small style="color: ${msg.userAi === 'ai' ? 'rgba(255,255,255,0.7)' : 'rgba(255,255,255,0.6)'}; font-weight: 500;">
                                        ${msg.userAi === 'ai' ? 'IzzyBots AI Agent' : 'User'}
                                    </small><br>
...
function updateDashboardTitle() {
    ...
    if (currentMode === 'email') {
        dashboardText.textContent = 'IzzyBots AI Lead Gen Dashboard';
    } else {
        dashboardText.textContent = 'IzzyBots AI Lead Gen Dashboard';
    }
}
