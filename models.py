...
class MessengerSession(db.Model):
    ...
    status = db.Column(db.String(50), nullable=False, default='active')  # active, resolved, escalated
    ...
    # QA Status System (same as email system)
    ...
    # Developer Feedback (same as email system)
    ...
    __table_args__ = (
        ...
        Index('idx_messenger_archived', 'archived'),
    )
